...
const categories = ["All", "OG", "ZK", "DeFi", "Modular", "Privacy", "Compilers", "Ethereum", "Solana", "AI", "Game", "Avalanche", "STARKS", "SNARKS", "Perpetuals", "OpCode", "Groth16", "AIR", "FRI","ECC", "DA", "Celestia", "Social", "Galadriel", "Mina"];
